...
For full cryptographic and protocol details see [`wg-holepunch-guide.md`](wg-holepunch-guide.md).
...
[MIT](LICENSE) — source at https://github.com/gutschke/wireguardrtc
