...
// CascadeSection was removed in v2 §11.3 — cascade is now a
// per-host-tunnel decision (`Tunnel.relayPolicy`) surfaced via the
// row-level Ask banner.  See `docs/ux-design-v2.md` §2 / §11.3 /
// §13.  The §13-layer-3 emergency kill-switch is hidden behind a
// long-press on the version label and lives in
// `ui/SettingsHiddenKillSwitch.kt`.
